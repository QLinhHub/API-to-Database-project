...
`usage: api.py [-h] [--newDatabase NEWDATABASE] [--newTable NEWTABLE] [--db_name DB_NAME] [--server SERVER] [--port PORT] [--user USER] [--password PASSWORD]`
    ...
    `--password PASSWORD   password of the sql server`
